...
const ApprovedFinalResults = () => {
    ...
    return (
        <React.Fragment>
            {viewResult.flag && <ViewAllResults studentData={viewResult.data} denyHandler={denyHandlerViewResult} showDeny={true} buttonName={null}/>}
            ...
            <div className={classes.contents}>
                ...
                <div className={classes.marks_form}>
                    ...
                    {!studentListDisplay.length && <h3>No Approved Final Results</h3>}
                    {!!studentListDisplay.length && <h3>Approved Final Results</h3>}
...
export default ApprovedFinalResults;