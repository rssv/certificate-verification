...
const FailedFinalResults = () => {
    ...
    const fetchSignedResults = async (accessToken) => {
        let response;
        try{
            response= await fetch("http://localhost:4000/results/final-failed",{
                method: 'GET',
                headers: {
        ...
        <React.Fragment>
            ...
            <div className={classes.contents}>
                ...
                <div className={classes.marks_form}>
                    ...
                    {!studentListDisplay.length && <h3>No Failed Final Results</h3>}
                    {!!studentListDisplay.length && <h3>Failed Final Results</h3>}
...
export default FailedFinalResults;